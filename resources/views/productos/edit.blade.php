...
<div class="crud-container" style="background-color: #2c2c2c; width: 100%; min-height: 100vh;">
    <h1 class="crud-header">Editar Producto</h1>

    <form action="{{ route('productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data" class="crud-form">
        @csrf
        @method('PUT')
        <div>
        ...
        <button type="submit" class="crud-button">Actualizar Producto</button>
    </form>
</div>
@endsection